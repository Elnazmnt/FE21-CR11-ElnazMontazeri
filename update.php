...
if (isset($_POST["submit"])) {
   ...
   if ($pictureArray->error === 0) {      
       ...
       $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name',  phone_number = '$phon', address ='$adr', email = '$email',picture = '$pictureArray->fileName' WHERE id = {$id}";
   } else {
       $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', phone_number = '$phon',  address ='$adr', email = '$email' WHERE id = {$id}";
   }
       ...
       <form  method="post" enctype="multipart/form-data">
           <table class="table">
               ...
               <tr>
                ...
                <tr>
                   <th>Last Name</th>
                   <td><input class="form-control" type= "text" name="phone_number"  placeholder="Last Name" value ="<?php echo $phon ?>" /></td>
               </tr>
               <tr>
                   <th>Last Name</th>
                   <td><input class="form-control" type= "text" name="address"  placeholder="Address" value ="<?php echo $adr ?>" /></td>
               </tr>
